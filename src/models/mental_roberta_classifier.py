...
def save_training_metadata(
    ...
    """Saves complete MentalRoBERTa training metadata for reproducibility."""
    metadata = {
        **training_config,
...
def run_local_smoke_test(data_dir="data/processed/splits", output_dir="models/mental_roberta"):
    """Executes a lightweight local CPU verification test without running full training."""
    print("=" * 70)
    print("RUNNING LOCAL SMOKE TEST (CPU Micro-Batch Verification - MentalRoBERTa)")
    print("=" * 70)
    ...
    print("\n5. Initializing Tokenizer & MentalRoBERTa Model...")
...
def run_full_training(
    ...
    """Executes full MentalRoBERTa fine-tuning with CUDA GPU enforcement."""
    print("=" * 70)
    print("PHASE 3 — MENTALROBERTA FULL FINE-TUNING PIPELINE")
    print("=" * 70)

    if not torch.cuda.is_available():
        print("\nERROR: CUDA GPU is unavailable.")
        print("Full MentalRoBERTa fine-tuning requires a CUDA GPU (e.g., Google Colab T4).")
    ...
    print("\nStarting MentalRoBERTa fine-tuning...")
    ...
    plot_and_save_confusion_matrix(
        ...
        CANONICAL_LABELS,
        "Validation Confusion Matrix - MentalRoBERTa",
        os.path.join(plots_dir, "cm_val_mental_roberta.png"),
    )
    ...
    plot_and_save_confusion_matrix(
        ...
        CANONICAL_LABELS,
        "Test Confusion Matrix - MentalRoBERTa (Evaluated Once)",
        os.path.join(plots_dir, "cm_test_mental_roberta.png"),
    )
    ...
    print("\nAll MentalRoBERTa artifacts saved successfully!")
    print("=" * 70)


if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="MentalRoBERTa Mental Health Classifier")
